...
const HeroSection = () => {
    ...
    const slides = [
      ...
      },
      {
        ...
        textGradient: "from-orange-700 to-orange-900",
      },
      {
        id: 3,
        image: banner3,
        ...
        textGradient: "from-yellow-700 to-yellow-900",
      },
      {
        id: 4,
        image: banner4,
        ...
        cta: "Explore Now",
        accent: "from-green-400/30 to-transparent",
        textGradient: "from-green-700 to-green-900",
      }
    ];
