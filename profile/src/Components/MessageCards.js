            ...
            <div className="max-w-[1920px] mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                    ...
                    >
                        ...
                        <div className="max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-transparent pr-2">
                            <p className="font-garamond text-base text-gray-700 leading-relaxed mb-3">
                                It is with immense gratitude and pride that I address you as the Founder of HD Fruit Alliances. Our journey in the fruit industry spans four generations, built on a foundation of trust, quality, and an unwavering commitment to excellence.
                            </p>
                    ...
                    >
                        ...
                        <div className="max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-transparent pr-2">
                            <p className="font-garamond text-base text-gray-700 leading-relaxed mb-3">
                                At HD Fruit Alliances, our mission is simple yet profound—to deliver the finest fruits with the highest standards of freshness, nutrition, and quality.
                            </p>
                            <p className="font-garamond text-base text-gray-700 leading-relaxed">
                    ...
                    >
                        ...
                        <div className="max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-transparent pr-2">
                            <p className="font-garamond text-base text-gray-700 leading-relaxed mb-3">
                                At HD Fruit Alliances, our commitment to quality and sustainability drives everything we do. We take pride in delivering the freshest and finest fruits, sourced responsibly and with care.
                            </p>
                            <p className="font-garamond text-base text-gray-700 leading-relaxed">
